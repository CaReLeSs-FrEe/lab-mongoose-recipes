...
mongoose
  .connect(MONGODB_URI)
  .then(x => { // x - connectionInformation
  ...
  .then(() => {
    const recipe = {
      title: 'Cake Monster', 
      level: 'Easy Peasy',
      ingredients:['flour','cookies', 'milk', 'eggs', 'butter', 'baking soda'], 
      cuisine:'American', 
      dishType:'dessert', 
      duration:30, 
      creator:'Cookie Monster Himself', 
    }
  ...
  console.log('Success deleted', deleteOneResults)
}).catch(error => {
